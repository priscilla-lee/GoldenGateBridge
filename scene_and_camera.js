...
/* Create the road, given the path. */
  function createRoad() {
    ...
    var roadMat = new THREE.MeshPhongMaterial({color: "#dbdbaf" /*c2c2a3"*/, side: THREE.DoubleSide});
    ...
    var leftPath = surface.intersect(tube).toMesh(roadMat);
    leftPath.position.y = bridgeDims.bridge.clearance;
    road.add(leftPath);
  ...
  function createVehicles() {
    var vehicles = [];
      vehicles.push(createHatchback("red"));
      vehicles.push(createSedan("red"));
      vehicles.push(createVan("red"));
      vehicles.push(createTruck("red", "white"));
      vehicles.push(createBus());
      vehicles.push(createHatchback("green"));
      vehicles.push(createSedan("green"));
      vehicles.push(createVan("green"));
      vehicles.push(createTruck("green", "white"));
      vehicles.push(createBus());
      vehicles.push(createHatchback("blue"));
      vehicles.push(createSedan("blue"));
      vehicles.push(createVan("blue"));
      vehicles.push(createTruck("blue", "white"));
      vehicles.push(createBus());
      vehicles.push(createHatchback("purple"));
      vehicles.push(createSedan("purple"));
      vehicles.push(createVan("purple"));
      vehicles.push(createTruck("purple", "white"));
      vehicles.push(createBus());
      return vehicles;
  }
